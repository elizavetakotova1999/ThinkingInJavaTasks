...
public class Countries {
    ...
    //  Создание частичной карты размера(size) стран
    ...
    // Используйте AbstractMap, реализуя entrySet()
    private static class FlyweightMap extends AbstractMap<String, String> {
        ...
        // Используйте AbstractSet, реализуя size() и iterator()
